...
extension TicTacToe {
    ...
    final class Controller: ViewModelController<TicTacToe.ContentView.Model>, TicTacToePresentableListener {
        ...
        func placeCurrentPlayerMark(atRow row: Int, col: Int) {
            ...
            viewModel.setCell(atRow: row, col: col, withPlayerType: currentPlayer)
            ...
            if endGame.didEnd {
                ...
                viewModel.announce(winner: endGame.winner)
            }
        }

        func closeGame() {
            listener.ticTacToeDidEnd()
        }
